...
select pid, name from performer;

select * from performer;

select pid, name from performer where pid > 5;

select pid, name from performer where name like '%del%';

select * from performer where pid != 5;

select * from performer where pid in(3, 4, 9); 

select * from performer where pid between 3 and 8;

select *, count(*) from cd where 2=2;

select * from cd where 5=2;

select year from cd;

select distinct year from cd;

select * from cd, track;

select * from cd, track where cd.cid = track.cid;

select  pid, name from performer, track where performer.pid = track.pid and pos >11;

select  track.pid, name from performer, track where performer.pid = track.pid and pos >11;

select distinct track.pid, name from performer, track where performer.pid = track.pid and pos >11;

select stitle, pid, cid from track, song where track.sid = song. sid and pos = 10;

select stitle, ctitle, name,year
from song, cd, track, performer
where pos = 10 and track.sid = song.sid and cd.cid = track.cid and performer.pid = track.pid
order by year asc, stitle desc;

select ctitle, ceil(year/100)
from cd;					

select ctitle, floor(year/100)
from cd;
...
select *
from cd c1
where exists (select * from cd c2 where c1.year=c2.year and c1.cid <> c2.cid);
...
select * from cd natural join company;
